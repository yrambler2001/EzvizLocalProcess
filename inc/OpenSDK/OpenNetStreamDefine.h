...
enum MessageType
{
    ...
    INS_DOWNLOAD_START            = 13,  ///< 下载开始
    INS_DOWNLOAD_STOP             = 14,  ///< 下载结束
    INS_DOWNLOAD_EXCEPTION        = 15,  ///< 下载异常，比如接收超时，数据错误，写文件失败
    ...
    INS_USER_STOP_DOWNLOAD         =108   ///< 主动停止下载
};
